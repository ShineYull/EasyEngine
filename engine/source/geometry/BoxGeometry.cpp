...
namespace Shine {
	...
	BoxGeometry::BoxGeometry(float width, float height, float depth, float widthSegments, float heightSegments, float depthSegments)
	{
	...
	void BoxGeometry::buildPlane(int u, int v, int w, float udir, float vdir, float width, float height, float depth, float gridX, float gridY, float materialIndex)
	{
